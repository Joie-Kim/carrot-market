const Home = () => {
  return (
    <div className='grid min-h-screen gap-10 bg-slate-400 px-10 py-20'>
      <div className='rounded-3xl bg-white p-6 shadow-xl'>
        ...
        <button className='mx-auto mt-5 w-3/4 rounded-xl bg-blue-500 p-3 text-center text-white hover:bg-teal-500'>
          Checkout
        </button>
      </div>
