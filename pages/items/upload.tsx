const Upload = () => {
  return (
    <div className='px-4 py-16'>
      ...
      <button className='mt-4 w-full rounded-md border border-transparent bg-orange-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-orange-600 focus:ring-orange-500 focus:ring-offset-2'>
        Upload product
      </button>
    </div>
  );
